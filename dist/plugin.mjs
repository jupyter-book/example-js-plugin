  ...
  transforms: [
    {
      ...
      stage: "document",
      plugin: (_, utils) => (node) => {
        const test = (node2, index, parent) => {
          return parent && parent.type === "div" && parent.class?.includes("redact") && node2.type === "paragraph";
        };
        visit(node, test, (node2) => {
          node2.children = [{ type: "delete", children: node2.children }];
        });
      }
    }
  ]
